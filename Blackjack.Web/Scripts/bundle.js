...
/***/ function(module, exports, __webpack_require__) {
	...
	var Blackjack = React.createFactory(__webpack_require__(1));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameWidget = __webpack_require__(4);
	var websocket;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewPlayer = React.createClass({displayName: "NewPlayer",
	  connect: function() {
	  ...
	  render: function() {
	    return (
		  React.createElement("div", null, 
		    React.createElement("label", {htmlFor: "playerName"}, "Enter your name: "), 
	        React.createElement("input", {id: "playerName", name: "playerName", ref: "playerName", type: "text"}), 
	        React.createElement("input", {type: "button", value: "Connect", onClick: this.connect})
		  )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlayerList = __webpack_require__(7);
	  ...
	  render: function () {
	    var player = this.props.player || {},
		  ...
		  cards = hand.map(function (card) {
		    return React.createElement(Card, {suit: card.Suit, number: card.Number});
		  });
